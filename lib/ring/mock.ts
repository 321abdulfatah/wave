...
export const MOCK_EVENTS: DoorEvent[] = [
  {
    ...
    turns: [
      ...
      },
      {
        at: ago(11),
        from: 'door',
        text: 'Thank you. Please leave it inside the porch, out of the rain, and point down once it is placed.',
      },
      {
        at: ago(11),
        from: 'visitor',
        text: 'Point down — leaving it here',
        gesture: 'point',
        confidence: 0.87,
      },
